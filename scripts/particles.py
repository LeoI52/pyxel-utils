...
class TriangleParticle(ShapeParticle):
    ...
    def __init__(self, x:int, y:int, side_lenght:int, colors:int|list, lifespan:int, speed:int, target:tuple, friction:tuple=(0, 0), acceleration:tuple=(0, 0), grow:int=0, starting_angle:int=0, dither_duration:int=0, hollow:bool=False, rotating:bool=False, rotation_speed:int=1, zorder:int=0):
        super().__init__(x, y, side_lenght, side_lenght, colors, lifespan, speed, target, friction, acceleration, (grow, grow), dither_duration, hollow, zorder)
...
class StarParticle(ShapeParticle):
    ...
    def __init__(self, x:int, y:int, radius:int, points:int, colors:int|list, lifespan:int, speed:int, target:tuple, friction:tuple=(0, 0), acceleration:tuple=(0, 0), grow:int=0, dither_duration:int=0, hollow:bool=False, rotating:bool=False, rotation_speed:float=1, zorder:int=0):
        super().__init__(x, y, radius, radius, colors, lifespan, speed, target, friction, acceleration, (grow, grow), dither_duration, hollow, zorder)
...
class SpriteParticle(Particle):
    ...
    def __init__(self, x:int, y:int, animation:Animation, lifespan:int, speed:int, target:tuple, friction:tuple=(0, 0), acceleration:tuple=(0, 0), dither_duration:int=0, zorder:int=0):
        super().__init__(x, y, lifespan, speed, target, friction, acceleration, dither_duration, zorder)
...
class TextParticle(Particle):
    ...
    def __init__(self, x:int, y:int, text:str, colors:int|list, lifespan:int, speed:int, target:tuple, background_color:int=None, friction:tuple=(0, 0), acceleration:tuple=(0, 0), dither_duration:int=0, zorder:int=0):
        super().__init__(x, y, lifespan, speed, target, friction, acceleration, dither_duration, zorder)
        self.text = text
        ...
        if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT):
            if mode == "oval particle":
                for _ in range(5):
                    ...
                    particle_manager.add_particle(OvalParticle(pyxel.mouse_x, pyxel.mouse_y, s, s, [11, 10, 9, 8], 60, random.uniform(0.5, 1.5), (target_x, target_y), acceleration=(0, 0.01), dither_duration=20, wooble=True))
